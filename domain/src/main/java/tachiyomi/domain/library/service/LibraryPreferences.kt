...
class LibraryPreferences(
    ...
    fun libraryMarkDuplicateEpisodes() = preferenceStore.getBoolean("pref_library_mark_duplicate_episodes", false)
    // SY <--
    ...
    fun autoClearEpisdoeCache() = preferenceStore.getBoolean("auto_clear_episode_cache", false)
