...
class GetMergedReferencesById(
    ...
    suspend fun await(id: Long): List<tachiyomi.domain.anime.model.MergedAnimeReference> {
        return try {
    ...
    suspend fun subscribe(id: Long): Flow<List<tachiyomi.domain.anime.model.MergedAnimeReference>> {
