...
class SmartSearchMerge(
    ...
    private val insertMergedReference: tachiyomi.domain.anime.interactor.InsertMergedReference = Injekt.get(),
    private val networkToLocalAnime: NetworkToLocalAnime = Injekt.get(),
    private val deleteAnimeById: DeleteAnimeById = Injekt.get(),
    private val deleteByMergeId: tachiyomi.domain.anime.interactor.DeleteByMergeId = Injekt.get(),
    ...
    suspend fun smartSearchMerge(anime: Anime, originalAnimeId: Long): Anime {
        ...
        if (originalAnime.source == MERGED_SOURCE_ID) {
            ...
            if (children.isEmpty() || children.all { it.animeSourceId != MERGED_SOURCE_ID }) {
                animeReferences += tachiyomi.domain.anime.model.MergedAnimeReference(
                    id = -1,
                    isInfoAnime = false,
            ...
            val originalAnimeReference = tachiyomi.domain.anime.model.MergedAnimeReference(
                id = -1,
                isInfoAnime = true,
                getEpisodeUpdates = true,
                episodeSortMode = 0,
            ...
            val newAnimeReference = tachiyomi.domain.anime.model.MergedAnimeReference(
                id = -1,
                isInfoAnime = false,
                getEpisodeUpdates = true,
                episodeSortMode = 0,
            ...
            val mergedAnimeReference = tachiyomi.domain.anime.model.MergedAnimeReference(
                id = -1,
                isInfoAnime = false,
                getEpisodeUpdates = false,
                episodeSortMode = 0,
