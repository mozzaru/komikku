...
class SyncPreferences(
    ...
    fun getSyncTriggerOptions(): SyncTriggerOptions {
        return SyncTriggerOptions(
            syncOnEpisodeRead = preferenceStore.getBoolean("sync_on_episode_read", false).get(),
    ...
    fun setSyncTriggerOptions(syncTriggerOptions: SyncTriggerOptions) {
        preferenceStore.getBoolean("sync_on_episode_read", false)
            .set(syncTriggerOptions.syncOnEpisodeRead)
