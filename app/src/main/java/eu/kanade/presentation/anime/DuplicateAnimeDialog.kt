...
fun DuplicateAnimeDialog(
    ...
    AdaptiveSheet(
        ...
        Column(
            ...
            Text(
                text = stringResource(MR.strings.confirm_add_duplicate_anime),
...
fun DuplicateAnimesDialog(
    ...
    AlertDialog(
        ...
        text = {
            Column {
                Text(text = stringResource(MR.strings.confirm_add_duplicate_anime))
            ...
            FlowRow(
                ...
                FlowColumn {
                    TextButton(
                        ...
                        Text(text = stringResource(KMR.strings.action_allow_duplicate_anime))
                    }
