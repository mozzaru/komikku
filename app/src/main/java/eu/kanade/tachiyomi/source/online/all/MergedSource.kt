...
class MergedSource : HttpSource() {
    ...
    override fun fetchPageList(episode: SEpisode) = throw UnsupportedOperationException()
    override suspend fun getPageList(episode: SEpisode) = throw UnsupportedOperationException()
