...
class PagePreviewCache(private val context: Context) {
     ...
     */
    fun getPageListFromCache(manga: Anime, chapterIds: List<Long>, page: Int): ThumbnailPreviewPage {
     ...
     */
    fun putPageListToCache(manga: Anime, chapterIds: List<Long>, pages: ThumbnailPreviewPage) {
