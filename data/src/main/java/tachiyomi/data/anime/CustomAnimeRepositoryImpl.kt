...
class CustomAnimeRepositoryImpl(context: Context) : tachiyomi.domain.anime.repository.CustomAnimeRepository {
    ...
    private fun fetchCustomData(): MutableMap<Long, tachiyomi.domain.anime.model.CustomAnimeInfo> {
    ...
    override fun set(animeInfo: tachiyomi.domain.anime.model.CustomAnimeInfo) {
        if (
    ...
    data class AnimeJson(
        ...
        fun toAnime() = tachiyomi.domain.anime.model.CustomAnimeInfo(
    ...
    fun tachiyomi.domain.anime.model.CustomAnimeInfo.toJson(): AnimeJson {
        return AnimeJson(
            id,
            title,
            author,
